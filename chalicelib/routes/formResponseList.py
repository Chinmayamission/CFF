...
def form_response_list(formId):
    ...
    if query:
        ...
        search_fields = get(form.formOptions, "search.searchFields", ["_id"])
        result_limit = get(form.formOptions, "search.resultLimit", 10)
        result_fields = get(form.formOptions, "search.resultFields", ["_id"])
        mongo_query = {}
