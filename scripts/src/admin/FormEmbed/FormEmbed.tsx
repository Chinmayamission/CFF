    ...
    render() {
        ...
        return (
            <div>
                ...
                <pre>
                    &lt;iframe frameborder="0" style="width: 100%; height: 100vh" src="{`${window.location.protocol}//${window.location.host}/v2/forms/${this.props.formId}`}"&gt;
                    &lt;/iframe&gt;
                </pre>
...
function Embed(props) {
    return (<iframe frameBorder="0" style={{"width": "100%", "height": "100%"}} src={`${window.location.protocol}//${window.location.host}/v2/forms/${props.formId}`}>
    </iframe>);
}
