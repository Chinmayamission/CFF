...
: {headers: IHeaderObject[], dataFinal: any[]}
{
    ...
    let data = responses.map(e => ({
        ...
        "DATE_CREATED":  formattedDateTimeFromTimeStamp(e.date_created.$date) || String(e.date_created),
        "DATE_LAST_MODIFIED": formattedDateTimeFromTimeStamp(e.date_modified.$date) || String(e.date_modified),
