...
class FormEdit extends React.Component<IFormEditProps, IFormEditState> {
  constructor(props: any) {
    ...
    this.state = {
      ...
      formOptions: get(form, "formOptions", {
        paymentInfo: {},
      ...
      <div>
        <div className="form-inline">
          ...
          <button
            ...
            onClick={e => this.saveForm()}
          >
            Save Form
          </button>
          {get(this.state.formOptions, "dataOptions.export") &&
            this.state.formOptions.dataOptions.export.map(
              e =>
                e.type === "google_sheets" &&
                e.spreadsheetId && (
                  <div>
                    <a
                      target="_blank"
                      href={`https://docs.google.com/spreadsheets/d/${e.spreadsheetId}`}
                    >
                      Export {e.type} link
                    </a>
                  </div>
            ...
            <div className="col-12 ccmt-cff-editpage-jsoneditor-container">
              <Tabs>
                <TabList>
                  ...
                  <li className="react-tabs__tab">{this.renderTopPane()}</li>
                </TabList>
                {/* <TabPanel>
                ...
                <TabPanel>
                  <JSONEditor
                    ...
                    changeFromEditor={this.state.changeFromEditor}
                    onChange={e =>
                      this.onChange("schema", e, { changeFromEditor: true })
                    }
                ...
                <TabPanel>
                  <JSONEditor
                    ...
                    changeFromEditor={this.state.changeFromEditor}
                    onChange={e =>
                      this.onChange("uiSchema", e, { changeFromEditor: true })
                    }
