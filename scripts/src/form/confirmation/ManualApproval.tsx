 ...
 render() {
     ...
     return (<div>
         {this.state.loading && 
            <Loading />}
         {this.state.done &&
         <div dangerouslySetInnerHTML={{ "__html": sanitize(this.props.paymentMethodInfo.successMessage || "Your response has been submitted. You will receive a confirmation email with information about how to pay soon.") }} />
         }
         {!this.state.done &&
