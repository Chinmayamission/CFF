...
class Infobox extends React.Component<{ i: string, description: string }, { open: boolean }> {
    constructor(props) {
        super(props);
        this.state = {
            open: false
    ...
    render() {
        ...
        >
            <img
                ...
                style={{ "marginLeft": 10 }}
            />
            <Popover placement="right" isOpen={this.state.open} container={"#" + "Popover-container" + i} target={"Popover" + i} >
                <PopoverBody>
