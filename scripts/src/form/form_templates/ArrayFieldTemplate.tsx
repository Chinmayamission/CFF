...
class ArrayFieldTemplate extends React.Component<any, any> {
  ...
  renderNumItems() {
    ...
    return (<SelectWidget
      schema={{ title: this.props.uiSchema["ui:cff:arrayNumItemsTitle"] || `Number of ${this.props.uiSchema["ui:title"] || this.props.title || 'items'}`, type: "integer", enum: range, default: this.props.items ? this.props.items.length : 0 }}
