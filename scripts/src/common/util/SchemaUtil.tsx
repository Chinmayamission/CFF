export module SchemaUtil {
    ...
    export function isSchemaKey(key) {
        // not used -- use isUiSchemaKey from CreateSchemas for now.
        return /(enum|enumValues|title|description|items|dependencies|required|minItems)/g.test(key);
    }
