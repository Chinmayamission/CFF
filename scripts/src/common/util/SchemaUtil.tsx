export module SchemaUtil {
    export function objToSchemaPath(fieldPath) {
        ...
        return fieldPath
            ...
            .replace(/\.\d*\./g, ".items.")
            .replace(/\.properties\.(enum|enumValues|title|description|items|dependencies|required)/g, ".$1") // don't add "properties" before certain predefined keys of schema, as they aren't custom object properties.
    }
