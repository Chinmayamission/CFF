...
export const schema = {
  ...
  properties: {
    ...
    returning_family: {
      type: "boolean",
      title:
        "Was your family part of Chinmaya Mission Alpharetta (either SFMS or Marietta Locations) in 2017-2018?",
      enumNames: ["Yes", "No"]
    },
    home_phone: {
      type: "string",
    ...
    children: {
      ...
      items: {
        ...
        required: ["name", "grade", "dob", "gender"]
      }
    },
    parents: {
      title: "",
      ...
      items: {
        ...
        required: ["name", "email", "gender", "phone"]
      }
    }
  },
  required: [
        ...
        data: [
          {
            ...
            room: "Class Room One",
            teacher: "Teacher ID One"
          },
          {
            id: "CLASS2",
            displayName: "Class Name Two",
            room: "Class Room Two",
            teacher: "Teacher ID Two"
          }
        ],
        schema: {}
      }
...
export const responses = [
  {
    ...
    paymentInfo: {
      ...
      items: [
        ...
        {
          name:
            "New Family One-Time Fee - 2018-19 CMA Marietta Bala Vihar Registration",
        ...
        {
          name:
            "Convenience Fee - 2018-19 CMA Marietta Bala Vihar Registration",
...
export const renderedForm: IRenderedForm = {
  name: "Unit Test BV Registration Form",
  schema,
  uiSchema,
  formOptions,
  _id: { $oid: "123" }
