...
class CCMT_Forms_Subsite_Admin {
	...
	public function enqueue_scripts() {
		...
		wp_register_script( "ccmt-cff-edit-vendor", 'https://gcmw-media.s3.amazonaws.com/CFF/app.js');
		wp_register_script( "ccmt-cff-edit-app", 'https://gcmw-media.s3.amazonaws.com/CFF/vendor.bundle.js');
	}
