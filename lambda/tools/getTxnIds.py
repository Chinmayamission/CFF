...
ids = set([r["payment_status_detail"]["id"] for r in responses if "id" in r["payment_status_detail"]])
ids_to_resp_ids = {r["payment_status_detail"]["id"]: str(r["_id"]) for r in responses if "id" in r["payment_status_detail"]}

missed_ids = paypal_ids - ids

with open(os.path.join(os.path.dirname(__file__), "output.CSV"), 'w+') as csvfile:
    fieldnames = ["Date","Time","TimeZone","Name","Type","Status","Currency","Gross","Fee","Net","From Email Address","To Email Address","Transaction ID","Shipping Address","Address Status","Item Title","Item ID","Shipping and Handling Amount","Insurance Amount","Sales Tax","Option 1 Name","Option 1 Value","Option 2 Name","Option 2 Value","Reference Txn ID","Invoice Number","Custom Number","Quantity","Receipt ID","Balance","Address Line 1","Address Line 2/District/Neighborhood","Town/City","State/Province/Region/County/Territory/Prefecture/Republic","Zip/Postal Code","Country","Contact Phone Number","Subject","Note","Country Code","Balance Impact"]
