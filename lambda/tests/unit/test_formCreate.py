...
class FormCreate(unittest.TestCase):
  ...
  def test_form_create_blank(self):
    ...
    form = Form.objects.get({"_id": ObjectId(response['res']['form']['_id']['$oid']) })
  ...
  def test_form_create_copy(self):
    ...
    Form(
        ...
        formOptions=FormOptions(confirmationEmailInfo={"a":"B"}, paymentInfo={"c":"D"}, paymentMethods={"E":"F"}, dataOptions={"G":"H"}, defaultFormData={"I":"J"}),
    ...
    response = form_create()
    form2 = Form.objects.get({"_id": ObjectId(response['res']['form']['_id']['$oid']) })
