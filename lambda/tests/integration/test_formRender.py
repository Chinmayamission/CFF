...
class FormRender(BaseTestCase):
    ...
    def test_render_form_with_predicate_response(self):
        ...
        self.edit_form(
            ...
            {
                "formOptions": dict(
                    loginRequired=True, successor={"formId": str(self.formId)}
                )
            },
        )
        self.edit_form(
        ...
        self.assertEqual(
            body["res"],
            {"form": predicate["formId"], "value": {"grade": "C", "age": 3}},
        )
    ...
    def test_render_form_with_predicate_invalid_successor(self):
        ...
        self.edit_form(
            ...
            {
                "formOptions": dict(
                    loginRequired=True, successor={"formId": "anotherformid"}
                )
            },
        )
        self.edit_form(
        ...
        self.assertEqual(
            body["error"], "Successor formId doesn't match current formId."
        )
        self.delete_form(predicate["formId"])
