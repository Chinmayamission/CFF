...
from tests.unit.test_email import (
        ...
        self.assertEqual(
            body,
            {
                ...
                "email": {
                    ...
                    "bccEmail": "",
                    "ccEmail": "",
                    "msgBody": "<h1>Action Needed:</h1><h2>2018 Jagadeeshwara Mandir Suvarna Mahotsava Yajman Sponsorship Form</h2>Thank you for registration. As per Government of India FCRA guideliness CCMT is required to keep  proof of Identity of the donor and hence we request you to send a copy of your passport to CCMT CFO a.b@chinmayamission.com, copied on this email.<br><table><tr><th>email</th><td>success@simulator.amazonses.com</td></tr></table><br><table><tr><th>Name</th><th>Description</th><th>Amount</th><th>Quantity</th></tr><tr><td>123</td><td>456</td><td>1</td><td>1</td></table>",
                },
            },
        )
        # todo: add more stuff.
