...
paymentMethods = {'paypal_classic': {'address1': 'test', 'address2': 'test', 'business': 'aramaswamis-facilitator@gmail.com', 'city': 'test', 'cmd': '_cart', 'email': 'success@simulator.amazonses.com', 'first_name': 'test', 'image_url': 'http://omrun.cmsj.org/wp-content/uploads/2017/01/cropped-Om-run-512px.png',
                                     'item_name': 'Ashwin', 'item_number': 'Registration for ' 'Training Only', 'last_name': 'test', 'sandbox': True, 'state': 'test', 'zip': '.'}, 'paypal_old_not_used': {'client': {'sandbox': 'AQnuMqn24Q8xTChC8uSgCOnmDjeMXZ1O7ZNS0uCHIsOmcoHqA6g2acYhTa_Qv-euJJ8UVFh4zmhJAWQR'}, 'env': 'sandbox'}}
