...
DEV_COGNITO_IDENTITY_ID_SPLIT = "f31c1cb8-681c-4d3e-9749-d7c074ffd7f6"
...
FORM_DATA_ONE = {
    "modifyLink": "http://omrun.cmsj.org/training-thankyou/",
    "data": {
        "acceptTerms": True,
...
FORM_V2_RENDER_RESP = {
    "version": 1.0,
    "uiSchema": {
        "phone": {"ui:widget": "phone", "ui:placeholder": "Phone Number"},
        "contact_name": {
            "last": {"classNames": "col-12 col-sm-6"},
            "ui:order": ["first", "last"],
            "first": {"classNames": "col-12 col-sm-6"},
        },
        "ui:order": [
            "contact_name",
            "email",
    ...
    "schema": {
        ...
        "properties": {
            "area_expertise": {"title": "Area of Expertise", "type": "string"},
            "contact_name": {
                "ui:order": ["first", "last"],
                "title": " ",
                "type": "object",
        ...
        "required": ["contact_name", "email", "area_expertise"],
    },
